...
<!-- 	<div class="row">
		 	...
		 	<div class="col-md-4">
				...
				<div class="list-group">
					<a href="cate-wtfean.jsp" class="list-group-item">한식</a> 
			...
			<div class="col-lg-15">
				...
				<h1 align="center">추천 양식 메뉴는 <%=keyword_wtf%> 입니다.</h1>
        ...
        if (pageData.getPrevPage() > 0) {
            String link1 = String.format("<a href='random_menu_Wtf.jsp?page=%d&keyword_wtf=%s'>[이전]</a>", 
                    pageData.getPrevPage(),keyword_wtf);
            out.println(link1);
        } else {
            out.println("[이전]");
        }
        ...
        for (int i = pageData.getStartPage(); i <= pageData.getEndPage(); i++) {
            if (i == nowPage) {
                ...
                String link1 = String.format("<a href='random_menu_Wtf.jsp?page=%d&keyword_wtf=%s'>[%d]</a>", i,keyword_wtf,i);
                out.println(link1);
            }
        }

        if (pageData.getNextPage() > 0) {
            String link1 = String.format("<a href='random_menu_Wtf.jsp?page=%d&keyword_wtf=%s'>[다음]</a>",
            		pageData.getNextPage(),keyword_wtf);
            out.println(link1);
        } else {
            out.println("[다음]");
        }

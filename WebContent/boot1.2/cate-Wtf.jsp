...
<body>
	...
	<div class="container">
        ...
        if (pageData.getPrevPage() > 0) {
            String link1 = String.format("<a href='cate-Wtf.jsp?page=%d'>[이전]</a>", 
        ...
        for (int i = pageData.getStartPage(); i <= pageData.getEndPage(); i++) {
            if (i == nowPage) {
                ...
                String link1 = String.format("<a href='cate-Wtf.jsp?page=%d'>[%d]</a>", i, i);
                out.println(link1);
            }
        }

        if (pageData.getNextPage() > 0) {
            String link1 = String.format("<a href='cate-Wtf.jsp?page=%d'>[다음]</a>",

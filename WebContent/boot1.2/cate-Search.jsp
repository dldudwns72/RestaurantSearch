<%@page import="study.model1.mybatis.model.Img_Search"%>
<%@page import="study.model1.mybatis.service.Impl.Image_SearchServiceImpl"%>
<%@page import="study.model1.mybatis.service.Image_SearchService"%>
...
<%
	...
	Image_SearchService imagesearchService = new Image_SearchServiceImpl(sqlSession);
		...
		Img_Search.Items input2 = new Img_Search.Items();
		input2.setTitle(keyword);
		
		// 빈즈를 담을 객체 생성
		List<Restaurants.Items> output = null;
		List<Img_Search.Items> output2 = null;
...
<body>
	...
	<div class="container">
			...
			%> 
					...
					<!-- <form method = "get" action = "cate-Search.jsp"> -->
						<div class="card h-100">
							<a href="place_info.jsp"> <img src="#" width="222"
								height="128"></a>
							<div class="card-body">
								<h4 class="card-title">
        ...
        if (pageData.getPrevPage() > 0) {
            String link1 = String.format("<a href='cate-Search.jsp?page=%d&keyword=%s'>[이전]</a>", 
        ...
        for (int i = pageData.getStartPage(); i <= pageData.getEndPage(); i++) {
            if (i == nowPage) {
                ...
                String link1 = String.format("<a href='cate-Search.jsp?page=%d&keyword=%s'>[%d]</a>", i,keyword,i);
                out.println(link1);
            }
        }

        if (pageData.getNextPage() > 0) {
            String link1 = String.format("<a href='cate-Search.jsp?page=%d&keyword=%s'>[다음]</a>",

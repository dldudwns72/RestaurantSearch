...
<!-- 	<div class="row">
		 	...
		 	<div class="col-md-4">
				...
				<div class="list-group">
					<a href="cate-cafeean.jsp" class="list-group-item">한식</a> 
			...
			<div class="col-lg-15">
				...
				<h1 align="center">추천 카페 메뉴는 <%=keyword_cafe%> 입니다.</h1>
        ...
        if (pageData.getPrevPage() > 0) {
            String link1 = String.format("<a href='random_menu_Cafe.jsp?page=%d&keyword_cafe=%s'>[이전]</a>", 
                    pageData.getPrevPage(),keyword_cafe);
            out.println(link1);
        } else {
            out.println("[이전]");
        }
        ...
        for (int i = pageData.getStartPage(); i <= pageData.getEndPage(); i++) {
            if (i == nowPage) {
                ...
                String link1 = String.format("<a href='random_menu_Cafe.jsp?page=%d&keyword_cafe=%s'>[%d]</a>", i,keyword_cafe,i);
                out.println(link1);
            }
        }

        if (pageData.getNextPage() > 0) {
            String link1 = String.format("<a href='random_menu_Cafe.jsp?page=%d&keyword_cafe=%s'>[다음]</a>",
            		pageData.getNextPage(),keyword_cafe);
            out.println(link1);
        } else {
            out.println("[다음]");
        }
